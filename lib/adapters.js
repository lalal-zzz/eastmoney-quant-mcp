...
const skillNames = ["eastmoney-quant", "eastmoney-quant-data-init", "eastmoney-quant-stock-screening", "eastmoney-quant-report-generation", "eastmoney-quant-multi-timeframe", "eastmoney-quant-strategy-backtest"]
...
function copySkills(packageRoot, root) {
  ...
  const mapping = {
    ...
    "eastmoney-quant-multi-timeframe": join("multi-timeframe-analysis", "SKILL.md"),
    "eastmoney-quant-strategy-backtest": join("strategy-backtest", "SKILL.md"),
  }
